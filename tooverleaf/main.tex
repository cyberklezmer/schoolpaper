...
Unclarities:
\begin{itemize}
\item Kinergartens opened whole autumn
\item What was open on 30 November - grades 1-5 in full, grades 6-8 weekly rotations, grade 9 in full (complication for grammar schools, where equivalents of grades 6-9 in rotations) (these were open from Nov 30)
\item Rotations in Autumn - see above
\item + FROM FEB 27 - closed kindergartes, grades 1-9, secondary
\end{itemize}
